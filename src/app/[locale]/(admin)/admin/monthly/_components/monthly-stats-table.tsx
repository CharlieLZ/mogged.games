...
import type { MonthlyStat } from '@/shared/models/admin-daily';

interface MonthlyStatsTableProps {
  stats: MonthlyStat[];
}

export function MonthlyStatsTable({ stats }: MonthlyStatsTableProps) {
  const t = useTranslations('admin.monthly');
  ...
  return (
    <div className="rounded-md border">
      <Table>
        <TableHeader>
          <TableRow>
            <TableHead className="w-[120px]">{t('table.month')}</TableHead>
