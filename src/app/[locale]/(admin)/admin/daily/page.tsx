...
import { getAdminDailyPageData } from '@/shared/services/admin-dashboard';
...
import { DailyStatsTable } from './_components/daily-stats-table';
...
export default async function AdminDailyPage({
  ...
  const { dailyStats, funnelStats, acquisitionBreakdowns } =
    await getAdminDailyPageData(30);
  ...
  const sortedFunnelStats = [...funnelStats].reverse();
    ...
    <>
      ...
      <Main>
        ...
        <div className="space-y-6">
          <DailyStatsTable stats={sortedStats} />
          ...
          <Card>
            ...
            <CardContent>
              <FunnelStatsTable
                periodLabel="date"
                stats={sortedFunnelStats}
                translationNamespace="admin.daily"
              />
            </CardContent>
          </Card>
