...
import { UpdateUser, updateUser } from '@/shared/models/user';
...
export default async function ProfilePage() {
  ...
  const unauthenticatedMessage = t('edit.messages.unauthenticated');
  const nameRequiredMessage = t('edit.messages.nameRequired');
  const updatedMessage = t('edit.messages.updated');
