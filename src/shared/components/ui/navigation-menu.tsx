...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      {children}{" "}
      <ChevronDownIcon
        className="relative top-[1px] ml-1.5 size-3 opacity-75 transition duration-300 group-data-[state=open]:translate-y-px rtl:ml-0 rtl:mr-1.5"
        aria-hidden="true"
        strokeWidth={2.5}
      />
    </NavigationMenuPrimitive.Trigger>
...
function NavigationMenuContent({
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        "left-0 top-0 w-full p-2 pr-2.5 md:absolute md:w-auto rtl:left-auto rtl:right-0 rtl:pr-2 rtl:pl-2.5",
