            ...
            <DropdownMenuContent>
              ...
              {user.email && supportEmail ? (
                <>
                  <DropdownMenuItem
                    className="w-full cursor-pointer"
                    onSelect={() => setIsContactSupportOpen(true)}
                  >
                    <LifeBuoy />
                    <span>{supportT('menu_title')}</span>
                  </DropdownMenuItem>
                  <DropdownMenuSeparator />
                </>
              ) : null}
