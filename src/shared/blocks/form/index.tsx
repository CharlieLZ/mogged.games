      ...
      if (field.type === 'switch') {
        ...
        if (Array.isArray(val)) {
          ...
          try {
            ...
            defaultValues[field.name] = Array.isArray(jsonValue)
              ? jsonValue
              : [];
          } catch {
            defaultValues[field.name] = [];
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      {item.type === 'textarea' ? (
                        ...
                        <Select field={item} formField={field} />
                      ) : item.type === 'switch' ? (
                        <Switch formField={field} />
                      ) : item.type === 'checkbox' ? (
                        <Checkbox field={item} formField={field} />
                      ) : item.type === 'markdown_editor' ? (
                        <Markdown field={item} formField={field} />
                        ...
                        <Input field={item} formField={field} />
                      )}
                    </FormControl>
                    {item.tip && (
                      <FormDescription
