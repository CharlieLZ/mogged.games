...
export async function getSettingTabs(tab = 'general') {
...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      name: 'zeptomail',
      title: 'ZeptoMail',
      description: 'custom your ZeptoMail API settings',
      tab: 'email',
    },
    {
      name: 'resend',
    ...
    {
      name: 'seedance',
      title: 'Seedance Runtime',
      description:
        'Default provider, fallback order, and routing controls for the unified Seedance 2.0 layer',
      tab: 'ai',
    },
    {
      name: 'volcengine',
      ...
      description:
        'Official Seedance 2.0 route on Volcengine Ark. Recommended primary provider when VOLCENGINE_API_KEY is available.',
      tab: 'ai',
    },
    {
      name: 'kie',
      title: t('groups.kie'),
      description:
        'Fallback route for Seedance 2.0. Enabled by default once the KIE key is available; set the runtime switch to false only for emergency rollback.',
      tab: 'ai',
    },
    {
      name: 'openrouter',
...
export async function getSettings() {
  const settings: Setting[] = [
    ...
    },
    {
      ...
      group: 'credit',
      tab: 'general',
      tip: 'initial credits expire after this many days; default is 14 days',
    },
    {
    ...
    {
      name: 'daily_claim_credits_amount',
      title: 'Daily Claim Credits Amount',
      type: 'number',
      placeholder: '15',
      group: 'credit',
      tab: 'general',
      tip: 'daily claim credits amount for user',
    },
    {
      name: 'daily_claim_credits_valid_days',
      title: 'Daily Claim Credits Valid Days',
      type: 'number',
      placeholder: '7',
      group: 'credit',
      tab: 'general',
      tip: 'daily claim credits expire after this many days; default is 7 days',
    },
    {
  ...
  "premium-yearly": "prod_xxx"
    ...
    {
      name: 'enable_ads_tracking',
      title: 'Enable Ads Tracking',
      type: 'switch',
      value: true,
      group: 'google_ads',
      tab: 'analytics',
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'AW-18038559972',
      group: 'google_ads',
      tab: 'analytics',
    },
    {
      name: 'google_ads_signup_label',
      title: 'Google Ads Signup Label',
      type: 'text',
      placeholder: 'kFg9CMXa844cEOSpuplD',
      group: 'google_ads',
      tab: 'analytics',
    },
    {
      ...
      type: 'text',
      placeholder: '3ElXCMja844cEOSpuplD',
      group: 'google_ads',
      tab: 'analytics',
    },
    {
      ...
      type: 'text',
      placeholder: 'jpUOCMva844cEOSpuplD',
      group: 'google_ads',
      tab: 'analytics',
    },
    {
      name: 'google_ads_purchase_tracking_mode',
      title: 'Google Ads Purchase Tracking Mode',
      type: 'select',
      value: 'browser',
      options: [
        { title: 'Browser Tag', value: 'browser' },
        { title: 'Server Import', value: 'server' },
      ],
      group: 'google_ads',
      tab: 'analytics',
    },
    ...
    },
    {
      ...
      title: 'ZeptoMail Send Mail Token',
      type: 'password',
      placeholder: '',
      group: 'zeptomail',
      tab: 'email',
    ...
    },
    {
      ...
      type: 'text',
      placeholder: '',
      tip: '用于拼出默认 R2 Endpoint，不填就需要在 Endpoint 里写完整地址',
      group: 'r2',
      tab: 'storage',
    },
    {
    ...
    {
      name: 'seedance_kie_enabled',
      title: 'KIE Enabled',
      type: 'switch',
      value: 'true',
      tip: 'Default-on runtime switch for the Volcengine -> KIE fallback chain. Set false only when you need an emergency official-only rollback.',
      group: 'seedance',
      tab: 'ai',
    },
    {
      ...
      type: 'password',
      placeholder: '',
      tip: 'Official Ark API key. Runtime prefers process.env.VOLCENGINE_API_KEY, then this stored value, then ARK_API_KEY.',
      group: 'volcengine',
      tab: 'ai',
    },
    {
      name: 'kie_api_key',
      title: 'KIE API Key (Test)',
      type: 'password',
      placeholder: 'kie_xxx',
      group: 'kie',
      tab: 'ai',
    ...
    {
      name: 'kie_api_key_free',
      title: 'KIE API Key (Free)',
      type: 'password',
      placeholder: 'kie_xxx',
      tip: 'Used for anonymous/free users. Maps to mogged.games-free project on KIE for cost tracking and rate limiting.',
      group: 'kie',
      tab: 'ai',
    },
    {
      name: 'kie_api_key_paid',
      title: 'KIE API Key (Paid)',
      type: 'password',
      placeholder: 'kie_xxx',
      tip: 'Used for paid/subscribed users. Maps to mogged.games-paid project on KIE for revenue/cost tracking.',
      group: 'kie',
      tab: 'ai',
    },
    {
      ...
      tip: 'Expected KIE Seedance base URL. Current docs use https://api.kie.ai plus /api/v1/jobs/createTask and /api/v1/jobs/recordInfo.',
      group: 'kie',
      tab: 'ai',
    },
    {
